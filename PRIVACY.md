...
- **Google account email** — used solely to authenticate with Google Drive for sync functionality.
...
- **Drive appData folder** — to sync your books and reading data across your devices. This is a hidden, app-private folder.
- **Drive file access** — to read books you place in the `SimpleBook/Import/` folder for import, and to delete them after successful import.
