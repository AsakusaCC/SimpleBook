...
import com.ebookreader.simplebook.domain.service.DesktopFileSource
import com.ebookreader.simplebook.ui.components.AdaptiveBookGrid
import com.ebookreader.simplebook.ui.components.DragDropOverlay
...
fun BookListScreen(
    ...
    DragDropOverlay(
        onFilesDropped = { files ->
            viewModel.importSources(files.map { DesktopFileSource(it) })
        },
        dropHint = strings.dropHereToImport
    ) {
